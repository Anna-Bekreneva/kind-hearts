...
import { ContactCard, ContactCardProps, Typography } from '@/components'

import s from './contacts.module.scss'

const dataContactCard: ContactCardProps[] = [
  {
    style: { backgroundColor: '#FFFAE9', borderColor: '#DFD1A2' },
    text: '77 Bowery, New York, NY\u00A010\u00A0002, 8th\u00A0floor',
    title: 'Office address',
  },
  {
    style: { backgroundColor: '#FBF8FF', borderColor: '#D7CCE5' },
    text: '63-36 110th St, Forest Hills, NY 11375',
    title: 'Warehouse address',
  },
  {
    style: { backgroundColor: '#F2FFEF', borderColor: '#CCDBC9' },
      ...
      <div className={'container'}>
        ...
        <div className={s.wrapper}>
          <ul className={s.items}>
            {dataContactCard.map((item, index) => {
              const { text, title, ...rest } = item

              return (
                <li className={s.item} key={index}>
                  <ContactCard text={text} title={title} {...rest} />
                </li>
              )
            })}
          </ul>
